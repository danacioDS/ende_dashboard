...
def load_and_transform_data():
    try:
        ...
        file_path = current_dir.parent / "data_generacion" / "serie_energia_generacion.xlsx"
        ...
        # Leer todas las columnas primero y luego filtrar
        df = pd.read_excel(file_path, engine="openpyxl")
        columnas_a_mantener = ['CENTRAL', 'GENERADOR'] + [col for col in df.columns if "Energía kWh" in col]
